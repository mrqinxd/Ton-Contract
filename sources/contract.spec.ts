...
// -------- Contract SDK --------
import { SampleJetton, Mint, TokenTransfer,EventMintRecord, loadEventMintRecord } from "./output/SampleJetton_SampleJetton";
...
describe("contract", () => {
    ...
    it("Test: Minting is successfully", async () => {
        ...
        console.log("sss"+mintResult.transactions);
        printSeparator();
        const totalSupplyAfter = (await token.getGetJettonData()).total_supply;
        
        console.log("aa"+totalSupplyAfter);
        // console.log("mintResult"+mintResult.externals[0].body.toBoc().toString("hex"))
        // let eventMint = loadEventMintRecord(mintResult.externals[0].body.asSlice())
        // console.log(eventMint.amount);
        // console.log(eventMint.minter);
    ...
    //         to: token.address,
    //     });
    //     console.log("Hex:"+messateResult.externals[0].body.toBoc().toString("hex"))
