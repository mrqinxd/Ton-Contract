...
export function storeEventMintRecord(src: EventMintRecord) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeUint(629077866, 32);
        b_0.storeAddress(src.minter);
        b_0.storeInt(src.amount, 257);
        b_0.storeAddress(src.recevier);
    };
}

export function loadEventMintRecord(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 629077866) { throw Error('Invalid prefix'); }
    let _minter = sc_0.loadAddress();
    let _amount = sc_0.loadIntBig(257);
    let _recevier = sc_0.loadAddress();
    return { $$type: 'EventMintRecord' as const, minter: _minter, amount: _amount, recevier: _recevier };
}

function loadTupleEventMintRecord(source: TupleReader) {
    let _minter = source.readAddress();
    let _amount = source.readBigNumber();
    let _recevier = source.readAddress();
    return { $$type: 'EventMintRecord' as const, minter: _minter, amount: _amount, recevier: _recevier };
}
...
function storeTupleEventMintRecord(source: EventMintRecord) {
    ...
    builder.writeNumber(source.amount);
    builder.writeAddress(source.recevier);
    return builder.build();
}
...
async function SampleJetton_init(owner: Address, content: Cell, max_supply: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const SampleJetton_types: ABIType[] = [
    ...
    {"name":"EventMintRecord","header":629077866,"fields":[{"name":"minter","type":{"kind":"simple","type":"address","optional":false}},{"name":"amount","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"recevier","type":{"kind":"simple","type":"address","optional":false}}]},
]
